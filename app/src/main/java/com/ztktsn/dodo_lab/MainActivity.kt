...
class MainActivity : AppCompatActivity(), PizzaAdapter.OnPizzaClickListener, PizzaAdapter.OnPriceButtonClickListener, PizzaAdapter.OnComboClickListener {
    ...
    private val pizzaList = listOf(
        ...
        Pizza("3", "Tomato With Olives", R.drawable.tomatoolivespizza, "A delightful combination of fresh tomatoes and savory olives makes this pizza a Mediterranean-inspired delight.", "2300"),
    ...
    private val comboList = listOf(
        Combo("7", "Gamer Combo", R.drawable.combo, "Real special combo for gamers", "5000")
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pizzaAdapter = PizzaAdapter(pizzaList, comboList, this, this, this) // Pass 'this' as the third parameter
    ...
    override fun onComboClick(combo: Combo) {
        val intent = Intent(this, Detailed::class.java)
        intent.putExtra("combo", combo)
        startActivity(intent)
    }

    override fun onComboPriceButtonClick(combo: Combo) {
